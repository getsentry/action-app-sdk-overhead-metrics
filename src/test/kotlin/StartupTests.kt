...
sealed class StartupTestsIOS(server: TestOptions.Server) :
    StartupTests(
        TestOptions(
            ...
            listOf(
                AppInfo(
                    // TODO name = "io.sentry.cocoa.test-app-plain",
                    name = "com.saucelabs.mydemoapp.ios",
                    path = Path.of("/Users/ivan/dev/sentry-cocoa2/Tests/Perf/test-app-plain.ipa")
                ),
//                AppInfo(
//                    // TODO name = "io.sentry.cocoa.test-app-sentry",
//                    name = "com.saucelabs.SwagLabsMobileApp",
//                    path = Path.of("/Users/ivan/dev/sentry-cocoa2/Tests/Perf/test-app-sentry.ipa")
//                )
            )
        )
    )
